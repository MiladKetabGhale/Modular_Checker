...
(* ActRulesSpecTheory
   ActRulesBoolTheory
   ActVarRulesSpecTheory
   ActVarRulesBoolTheory
   VictoriaRulesBoolTheory
   VictoriaRulesSpecTheory *)
...
val Functional_to_Logical_elect = Q.store_thm("Functional_to_Logical_elect",
 ...
 >> `!c. MEM c (DROP (LENGTH p3) p'3) ==> MEM c (MAP FST p2)`
        ...
        >> metis_tac[Functional_ElectAux_to_Logical,ELECT_Auxiliary_dec_def,ALL_NON_EMPTY_def,ALL_NON_ZERO_def,
         ...
         Logical_list_MEM_VICE_VERCA_TheFunctional,eqe_list_dec2_verified,functional_to_logical_update_pile_ACT,functional_to_logical_update_pile])
   >- rfs[ELECT_dec_def]) 
  >- rfs[ELECT_dec_def]);	 
...
REPEAT STRIP_TAC
  ...
  >> `!c. MEM c l1 ==> MEM c (MAP FST np)`
       by metis_tac [ELECT_Auxiliary_def,MEM,Valid_PileTally_def]
  >> fs[logical_to_functional_update_pile_ACT,logical_to_functional_update_pile]
