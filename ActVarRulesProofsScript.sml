...
val _ = new_theory "ActVarRulesProofs";
 ...
 Cases_on `j1` 
   >- (Cases_on `j2`   
    >- ((REPEAT STRIP_TAC >> PairCases_on `p` >> PairCases_on `p'`
      ...
      >> Cases_on `p3`)   
        >- fs[]    
	>- (fs[NULL_EQ,NULL,Functional_TransferAux_to_Logical,TRANSFER_Auxiliary_dec_def] 
	    >> metis_tac[MEM,NULL_EQ,NULL,subpile1_BlMem_trans2_IsCorrect,
